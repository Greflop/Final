...
namespace Kcaspher.AI
{
    class AI_W2L3
    {
        ...
        public AI_W2L3()
        {
            AI_w2l3.Add(new AI_moderate(Content_Manager.getInstance().Textures["focheur"], new Rectangle(Res.gI().ScaleX(760), Res.gI().ScaleY(450), Res.gI().ScaleX(60), Res.gI().ScaleY(100)),1)); // garde 1
            // garde 2
            AI_w2l3.Add(new AI_moderate(Content_Manager.getInstance().Textures["enemy1"], new Rectangle(Res.gI().ScaleX(515), Res.gI().ScaleY(156), Res.gI().ScaleX(40), Res.gI().ScaleY(40)),15)); // random vert
            AI_w2l3.Add(new AI_moderate(Content_Manager.getInstance().Textures["enemy3"], new Rectangle(Res.gI().ScaleX(60), Res.gI().ScaleY(120), Res.gI().ScaleX(60), Res.gI().ScaleY(60)),40)); // chiote
