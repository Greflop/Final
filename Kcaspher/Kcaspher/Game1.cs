...
namespace Projet_2._0
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public string posClient()
        {
            ...
            {
                test = "" + screenmanager.casper.Position.X + " " + screenmanager.casper.Position.Y + " 0";
            }
            else
            {
                test = "error";
        ...
        //public string posq()
        //{
        //    //int s = screenmanager.menuplay.c.pos2q.Count;
        //   // if (true)
        //  //  {
        //        //if (screenmanager.menuplay.c.pos2q != new Queue<string>())
        //        //{
        //            return screenmanager.menuplay.c.pos2q.Dequeue();
        //        //}
        //        //else
        //        //    return "connard";
        //   // }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //if (screenmanager.gametype == GameType.Menu_Play_Solo_world1_lvl1)//( screenmanager.menuplay.c != null)
            //{
            //    spriteBatch.DrawString(fontdebug, , new Vector2(camera.centre.X + 10, camera.centre.Y + 10), Color.Red);
            //}
