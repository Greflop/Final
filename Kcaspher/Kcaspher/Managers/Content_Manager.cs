...
namespace Projet_2._0
{
    class Content_Manager
    {
        ...
        public void LoadTextures(ContentManager Content)
        {
            ...
            AddTextures("Particules/heart", "heart");
            AddTextures("Particules/heart2", "heart2");
            ...
            AddTextures("boss/boss2", "boss2");
            AddTextures("boss/boss3", "boss3");
            AddTextures("boss/boss4", "boss4");
            AddTextures("boss/boss5", "boss5");
            AddTextures("feu/feu1", "feu1");
            AddTextures("feu/feu2", "feu2");
            AddTextures("feu/feu3", "feu3");
            AddTextures("Cinematicmagueule/Boss Ghostbusters", "Intro3");
            AddTextures("Cinematicmagueule/Casper GhostbustersEnd", "End3");
            AddTextures("Cinematicmagueule/Boss W1 Droite", "Trans1");
            AddTextures("Cinematicmagueule/Casper Mad Gauche", "End2");
            AddTextures("Cinematicmagueule/Boss W1 Gauche","Intro1");
            AddTextures("Cinematicmagueule/Casper Boss","Trans3");
